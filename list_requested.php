					...
					<section id="top" class="one dark cover" >
						...
						<div class="container" style="background-color: #0000008c;">
							...
							<header>
								...
								<h2 class="alt"><strong>Liste beantragt!</strong></h2>
								<hr>
								<h2>Bitte warte bis deine Anfrage verarbeitet wird.</h2>
							</header>

							<footer style="padding-bottom: 15px;">
								<a href="dashboard.php#list" class="button scrolly">Zurück zum Dashboard</a>
							</footer>
