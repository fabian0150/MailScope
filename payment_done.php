					...
					<section id="top" class="one dark cover" >
						...
						<div class="container" style="background-color: #0000008c;">
							...
							<header>
								...
								<h2 class="alt"><strong>Einzahlung erstellt!</strong></h2>
								<hr>
								<h2>Bitte warte bis deine Zahlung verarbeitet wird.</h2>
							</header>

							<footer style="padding-bottom: 15px;">
								<a href="dashboard.php#payments" class="button scrolly">Zurück zum Dashboard</a>
							</footer>
